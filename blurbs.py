...
BLURBS = {
    ...
    "Mars": (
        "the only planet whose surface we can make out from here",
    ...
    "Neptune": (
        "the planet worked out on paper before anyone saw it",
    ...
    "Betelgeuse": (
        "a red star near the end of its life",
    ...
    "Vega": (
        "the star the whole brightness scale was measured from",
    ...
    "Polaris": (
        "the star the northern sky turns around",
    ...
    "Antares": (
        "a red star so large that, put where the Sun is, it would reach out "
        "past Mars",
    ...
    "Altair": (
        "one of the nearest bright stars, 17 light years away",
    ...
    "Algol": (
        "a star that dims for a few hours every three days",
    ...
    "Deneb": (
        "one of the most distant stars the eye can see",
    ...
    "Procyon": (
        "the star that rises just before Sirius",
    ...
    "Achernar": (
        "a star spinning so fast that it is not round",
    ...
    "Hadar": (
        "the second of the two stars that point at the Southern Cross",
    ...
    "Pollux": (
        "the nearest giant star to the Sun",
    ...
    "Fomalhaut": (
        "one bright star alone in an empty stretch of sky",
    ...
    "Acrux": (
        "the brightest star of the Southern Cross",
    ...
    "Regulus": (
        "the brightest star of the lion",
    ...
    "Adhara": (
        "the star that outshone all the others five million years ago",
    ...
    # -------------------------------------------------------------- deep sky
    "Andromeda Galaxy": (
        "the furthest thing most people can see without a telescope",
    ...
    "Orion Nebula": (
        "a place where new stars are forming, visible to the eye",
    ...
    "Hercules Cluster": (
        "several hundred thousand stars packed into a ball",
    ...
    "Pleiades": (
        "a cluster of stars that most people count as six",
    ...
    "Ring Nebula": (
        "a ring of gas thrown off by a dying star",
    ...
    "Dumbbell Nebula": (
        "gas thrown off by a dying star, bright enough for binoculars",
    ...
    "Lagoon Nebula": (
        "a cloud of glowing gas you can see without a telescope",
    ...
    "Crab Nebula": (
        "the wreckage of a star seen exploding in 1054",
    ...
    "Triangulum Galaxy": (
        "the third largest galaxy near our own",
    ...
    "Double Cluster": (
        "two clusters of stars side by side in one view",
    ...
    "Milky Way": (
        "our own galaxy, seen from the inside",
        ...
        "show it at all."),
    "Perseids": (
        "the meteor shower most people have seen",
    ...
    "Geminids": (
        "the richest meteor shower of the year",
    ...
    "Quadrantids": (
        "a meteor shower that is over in about six hours",
    ...
    "Lyrids": (
        "the oldest meteor shower on record",
    ...
    # -------------------------------------------------------------- asterisms
    "Big Dipper": (
        "seven stars whose end points at the pole star",
    ...
    "Orion's Belt": (
        "three stars in a row that point at Sirius",
    ...
    "Southern Cross": (
        "four bright stars that point the way to the south pole of the sky",
    ...
    "Little Dipper": (
        "seven stars ending at the pole star",
    ...
    "Cassiopeia's W": (
        "five bright stars in the shape of a W",
    ...
    "Northern Cross": (
        "the brightest stars of the swan, in the shape of a cross",
    ...
    "Keystone": (
        "four faint stars marking the body of Hercules",
    ...
    "Kite": (
        "a diamond of stars standing on Arcturus",
    ...
    "Job's Coffin": (
        "a small box of four stars in the constellation of the dolphin",
    ...
    "Teapot": (
        "eight stars in Sagittarius shaped like a teapot",
    ...
    "Great Square": (
        "four stars around an empty patch of sky",
    ...
    "Hyades V": (
        "the nearest cluster of stars to us",
    ...
    "Winter Triangle": (
        "three bright stars in an almost equal triangle",
    ...
    "Winter Hexagon": (
        "six bright stars enclosing most of the winter sky",
    ...
    "Sickle": (
        "a backwards question mark that makes the lion's head",
    ...
    "Great Diamond": (
        "four bright stars covering most of the spring sky",
    ...
    "The Pointers": (
        "two stars that point at the Southern Cross",
    ...
    "Lyra": (
        "a small lopsided rectangle of stars below Vega",
    ...
    "Aquila": (
        "an eagle flying along the Milky Way",
    ...
    "Scorpius": (
        "a constellation that really does look like a scorpion",
    ...
    "Andromeda": (
        "a chain of stars running off the corner of the Great Square",
    ...
    "Orion": (
        "the easiest constellation to recognise",
    ...
    "Grus": (
        "a crane, drawn from a Dutch voyage in the 1590s",
    ...
    "Canis Major": (
        "the constellation that carries Sirius",
    ...
    "Canis Minor": (
        "a constellation made of only two stars",
    ...
    "Gemini": (
        "the twins, two lines of stars side by side, each with a bright star "
        "for a head",
    ...
    "Canes Venatici": (
        "two faint stars, with some of the finest galaxies behind them",
    ...
    "Centaurus": (
        "the constellation holding the nearest stars to the Sun",
    ...
    "Carina": (
        "the keel of a ship that was cut into three constellations",
    ...
    "Vela": (
        "the sails of a ship that was cut into three constellations",
    ...
    "Puppis": (
        "the stern of a ship that was cut into three constellations",
    ...
    "Aquarius": (
        "a large constellation with no bright star in it",
    ...
    "Aries": (
        "where the Sun stood at the start of spring two thousand years ago",
    ...
    "Capricornus": (
        "a goat with the tail of a fish",
    ...
    "Cepheus": (
        "a faint constellation shaped like a house",
    ...
    "Cetus": (
        "a sea monster holding a star that fades away and comes back",
    ...
    "Columba": (
        "a dove, invented to sit beside the great ship",
    ...
    "Corvus": (
        "four stars in a crooked square with nothing bright around them",
    ...
    "Hydrus": (
        "a small southern constellation, two letters away from Hydra",
    ...
    "Libra": (
        "stars that used to be the claws of the scorpion",
    ...
    "Ophiuchus": (
        "the thirteenth constellation the Sun passes through",
    ...
    "Pavo": (
        "a peacock, low in the southern sky",
    ...
    "Perseus": (
        "a long curve of stars lying in the Milky Way",
    ...
    "Phoenix": (
        "a southern bird beside the end of the river",
    ...
    "Piscis Austrinus": (
        "a fish with one bright star and little else",
    ...
    "Serpens": (
        "the one constellation split into two separate pieces",
    ...
    "Triangulum Australe": (
        "a small neat triangle in the far south",
